...
(() => {
  ...
  init_live_reload();
  var restartWebflow = async (modules2) => {
    ...
    if (!modules2 || modules2.includes("ix2")) {
    ...
    if (!modules2 || modules2.includes("commerce")) {
    ...
    if (modules2?.includes("lightbox"))
      Webflow.require("lightbox")?.ready();
    if (modules2?.includes("slider")) {
  ...
  var PropTween = /* @__PURE__ */ function() {
    function PropTween3(next, target, prop, start, change, renderer, data2, setter, priority) {
      this.t = target;
      this.s = start;
      this.c = change;
      this.p = prop;
  ...
  // src/utils/animations/clockAnimation.ts
  init_live_reload();
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function clockAnimation() {
    gsapWithCSS.set(".home_clock_animation-image", {
      y: "5rem"
    });
    gsapWithCSS.to(".home_clock_animation-image", {
      scrollTrigger: {
        markers: false,
    ...
    gsapWithCSS.to(".home_clock_animation-short-rotation", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_home_clock",
        start: "top 50%",
    ...
    gsapWithCSS.to(".home_clock_animation-long-rotation", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_home_clock",
        start: "top 50%",
    ...
    function animateClockHand() {
      ...
      const currentRotation = clockHand ? gsapWithCSS.getProperty(clockHand, "rotation") || 0 : 0;
      const newRotation = Number(currentRotation) + 5;
      gsapWithCSS.to(".home_clock_animation-long-rotation-auto", {
        scrollTrigger: {
          markers: false,
          trigger: ".section_home_clock",
          start: "25% 50%",
        ...
        duration: 0.25,
        delay: 1,
        onComplete: animateClockHand
        // Call the function again when animation completes
      });
    }
    animateClockHand();
  }

  // src/utils/animations/ctaRoundLoop.ts
  init_live_reload();
  var ctaRoundLoop = () => {
    gsapWithCSS.to(".hero_ai-challenge-wrapper", {
      rotate: 360,
      repeat: -1,
      duration: 10,
      ease: "linear"
  ...
  // src/utils/animations/dataCardsStagger.ts
  init_live_reload();
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function dataCardsStagger() {
  ...
  // src/utils/animations/heroTextSwitch.ts
  init_live_reload();
  function heroTextSwitch() {
    const textElement = document.querySelector(".hero_text-switch");
    if (!textElement) {
      return;
    }
    ...
    const interval = setInterval(switchText, 4e3);
  ...
  // src/utils/animations/homeCardsScroll.ts
  init_live_reload();
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function homeCardsScroll() {
  ...
  // src/utils/animations/marquee.ts
  init_live_reload();
  ...
  // src/utils/animations/pageTransition.ts
  init_live_reload();
  ...
  function gsapTransition() {
    ...
    const AnimationPageText = () => {
      const dataNamespace = import_core.data.next.namespace;
  ...
  // src/utils/animations/parallaxCta.ts
  init_live_reload();
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  ...
  // src/utils/animations/scrollTools.ts
  init_live_reload();
  function initFloatingLogosAnimation() {
    const logoElements = [
    ...
    if (logoAssets.length > 0 && assetSection) {
      logoAssets.forEach((asset, index) => {
        ...
        const rotationAmount = (45 + index * 45) / 1.5;
        gsapWithCSS.set(asset, {
          y: "20rem",
          rotateZ: 0
        });
  ...
  // src/utils/animations/sunRising.ts
  init_live_reload();
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  var fearBackgroundAnimation = () => {
    gsapWithCSS.set(".home_fear_background_2", {
      y: "5rem"
    });
    gsapWithCSS.to(".home_fear_background_2", {
      scrollTrigger: {
    ...
    gsapWithCSS.set(".home_fear_background_1, .home_fear_background_3", {
      y: "-5rem"
    });
    gsapWithCSS.to(".home_fear_background_1, .home_fear_background_3", {
      scrollTrigger: {
        trigger: ".section_home_fear",
        start: "0% 100%",
        end: "100% 0%",
  ...
  // src/utils/animations/swiperTools.ts
  init_live_reload();
  ...
  // src/utils/animations/switchBrand.ts
  init_live_reload();
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function initSwitchBrandAnimation() {
    ...
    ScrollTrigger2.create({
      ...
      // Trigger when the top of the element reaches the center of the viewport
      onEnter: () => {
  ...
  // src/utils/animations/switchBrandScroll.ts
  init_live_reload();
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function createSectionAnimation(section, headingTags, headingDots, darkmodeDivider, startValue = "-16 50%", endValue = "50% 50%") {
    gsapWithCSS.fromTo(
      [section, darkmodeDivider],
      {
        color: "white",
  ...
  function initColorScrollSolutions() {
  ...
  // src/utils/animations/teamAnimation.ts
  init_live_reload();
  ...
  function teamAnimation() {
    ...
    planetConfig.forEach((config3) => {
      const dots = document.querySelectorAll(config3.selector);
  ...
  // src/utils/components/autoTabs.ts
  init_live_reload();
  function autoTabs() {
    const tabs = document.querySelectorAll(".home_tabs_link");
    const panes = document.querySelectorAll(".home_tabs_pane");
    let currentIndex = 0;
    let intervalId;
    ...
    function animateLine() {
      tabs.forEach((tab) => {
        const line2 = tab.querySelector(".home_tabs_load");
        if (line2) {
      ...
      const line = currentTab.querySelector(".home_tabs_load");
      if (line) {
        setTimeout(() => {
          if (line) {
    ...
    function resetAnimation(index) {
      ...
      setTimeout(() => {
        changeTab();
        intervalId = setInterval(changeTab, 8e3);
      }, 0);
    }
  ...
  // src/utils/components/popupContact.ts
  init_live_reload();
  function popupContact() {
    const popupComponent = document.querySelector('[popup="contact"]');
    const popupWrapper = document.querySelector(".contact_cards");
    const popupBackground = document.querySelector(".contact_background-close");
  ...
  // src/utils/tools/localization.ts
  init_live_reload();
  function initLocalization() {
    ...
    const handleLanguageSwitch = (event2) => {
      const target = event2.target;
      const listRow = target.closest(".navbar_dropdown-list-row");
      if (!listRow) return;
  ...
  async function initMarker() {
    if (window.location.href.includes("webflow")) {
      await esm_default.loadWidget({
        project: "682ee90585032edfe9b89f0d"
      });
    }
  }
    ...
    transitions: [
      {
        ...
        leave(data2) {
          return gsapWithCSS.to(data2.current.container, {
            y: "-25vw",
            opacity: 0,
            duration: 0.5,
            ease: "power1.out"
        ...
        beforeEnter(data2) {
          gsapTransition();
          data2.next.container.style.height = "auto";
          data2.next.container.style.position = "relative";
        },
        after(data2) {
          gsapWithCSS.from(".hero_sun-wrapper, hero_background", {
            opacity: 0,
            duration: 1,
            delay: 1.75,
            ease: "power2.out"
          ...
          return gsapWithCSS.from(data2.next.container, {
            y: "25vw",
            opacity: 0,
            duration: 0.5,
            delay: 1.25,
  ...
  import_core2.default.hooks.beforeEnter(() => {
    initGlobalAnimations();
  });
  import_core2.default.hooks.beforeLeave((data2) => {
    data2.current.container.style.position = "absolute";
    data2.current.container.style.top = "0";
    data2.current.container.style.left = "0";
    data2.current.container.style.width = "100%";
    ScrollTrigger2.getAll().forEach((trigger) => trigger.kill(false));
  ...
  import_core2.default.hooks.afterEnter(() => {
